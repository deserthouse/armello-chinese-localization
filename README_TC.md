...
| **font** | 303.6MB | 文字 + 霞鶩文楷（簡繁）+ 思源宋體標題（簡繁各 SC/TC） |
| **artfont** | 243.3MB | 文字 + 簡中馬善政毛筆楷書 + 繁中莫大毛筆字體（繁中標題思源宋體 TC） |

- **textonly**——原版字型原汁原味，僅替換翻譯文字：適合只想要新翻譯文字、不想改動官方字型觀感的玩家。
- **font**——正文選用霞鶩文楷（帶楷書筆意的現代字型，字形圓潤溫和、久讀不累），標題選用思源宋體 Heavy（筆畫厚重的宋體，自帶碑刻般的分量感）：正文有溫度、標題有氣勢，適合想在**藝術效果與可讀性之間取得平衡**的玩家。
- **artfont**——正文整體換裝毛筆書法字型（簡中馬善政毛筆楷書、繁中莫大毛筆字體），筆墨韻味最濃，最貼合愛門羅的奇幻繪本氣質；代價是手寫筆跡的字形辨識度不如印刷體系字型，可讀性遜於 font 版：適合更看重**藝術表現**、願意為風格讓渡一點閱讀速度的玩家。
