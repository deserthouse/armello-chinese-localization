...
| 版本 | 大小 | 適合 |
|---|---|---|
| **textonly** | 42MB | 只改文字，保持官方字型 |
| **font** | 308MB | 文字 + 霞鶩文楷（清爽手寫楷體） |
| **artfont** | 271MB | 文字 + 馬善政毛筆楷書（粗獷書法風） |
...
本專案絕大部分翻譯、審校與工程開發工作由 **AI（大語言模型）** 完成，人類角色為需求提出、方向決策與最終驗收。文字品質因此可能存在 AI 翻譯的典型瑕疵，歡迎透過 Issue 回饋。
