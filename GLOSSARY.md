...
> 版本 1.2.1 ｜ 2026-09-24（与 glossary_master.json 同步）｜ 原版 1.1 ｜ 2026-09-11 ｜ 用途：作为 DeepSeek 翻译流水线的权威参照（机读版见 `glossary_master.json`）
...
## 十五、v1.2.1 增补（2026-09-24）

| 废弃变体 | 正解 | 说明 |
|---|---|---|
| 镜影披风 | 明镜披风 | Mirror Cape 统一（master 15 条已修，QA 扫描项） |
| 镜角 | 明镜披风 | 历史废弃项（v1.1 起） |
