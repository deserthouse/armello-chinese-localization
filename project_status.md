...
- **主菜单**：文楷（2026-09-19 写入 gd 包内 sc 图集，resS 原地覆写路线，真机验证楷体✅）——**待用户验收**
...
- 主菜单文字：文楷已写入 gd 包内图集（2026-09-19，resS 原地覆写+flipud，真机验证楷体✅）；resources.assets 那份是孤儿副本（旧烘焙落点，对菜单无效）。内嵌 set_image 路线引擎侧豆腐块不可用
- 主菜单 Logo：定制美术字（非字体，不处理）
- 全局规范：~/.zcode/AGENTS.md（跨项目 10 条纪律）

## 遗留事项

- **主菜单字体修复**：✅ 已写入并真机验证（2026-09-19），**待用户验收**；恢复"卡牌图鉴"措辞需 gd TMP 表捐献格（鉴→党格安全，"党"全文 0 次），未做
